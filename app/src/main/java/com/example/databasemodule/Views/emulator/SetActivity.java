...
import com.example.databasemodule.Bluetooth.bluetoothfragment.GetFragment;
import com.example.databasemodule.Bluetooth.bluetoothfragment.SetFragment;
...
public class SetActivity extends SampleActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_set_emulator);

        if (savedInstanceState == null) {
            final FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            final SetFragment fragment = new SetFragment();
            transaction.replace(R.id.set_content_fragment, fragment);
            transaction.commit();
        }
    }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        logToggle.setVisible(findViewById(R.id.set_log_output) instanceof ViewAnimator);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_toggle_log:
                mLogShown = !mLogShown;
                ViewAnimator output = findViewById(R.id.set_log_output);
                if (mLogShown) {
    ...
    public void initializeLogging() {
        ...
        final LogFragment logFragment = (LogFragment) getSupportFragmentManager()
                .findFragmentById(R.id.set_log_fragment);
