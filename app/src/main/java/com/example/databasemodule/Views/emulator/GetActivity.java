...
public class GetActivity extends SampleActivityBase {

    public static final String TAG = "GetActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_emulator);

        if (savedInstanceState == null) {
            final FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            final GetFragment fragment = new GetFragment();
            transaction.replace(R.id.get_content_fragment, fragment);
            transaction.commit();
        }
    }
    ...
    public void initializeLogging() {
        ...
        final LogFragment logFragment = (LogFragment) getSupportFragmentManager()
                .findFragmentById(R.id.get_log_fragment);
